...
namespace HW5
{
    class MainClass
    {
        ...
        static int[,] Multiplication(int[,] matrix, int factor)
        {
        ...
        static int[,] MultiplacationMatrix(int[,] matrix1, int[,] matrix2)
        {
        ...
        static string GetStringWithMinimalWord(string text)
        {
        ...
        static List<String> GetStringWithMaximalWordLength(string text)
        {
        ...
        static char[] RemoveDublicateChar(string s)
        {
        ...
        static uint AckermannF(uint n, uint m)
        {
            if (n == 0)
                return m + 1;
            else
